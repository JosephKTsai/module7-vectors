...
q <- c(z[2:5]) #You can use a colon to choose the range of elements that you want in your new vector
...
all(even %% 2 == 0)
# The all function checks every element in the vector for the given conditions
# modulo %% gives the remainder of the element divided by the given number (in this case, 2)
